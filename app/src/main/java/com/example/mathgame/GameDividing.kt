...
class GameDividing : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        class AnswerInputFieldIndicator {
            val userInputHeader = findViewById<TextView>(R.id.et_dividing_user_result_card_header)
            val userInputStroke = findViewById<MaterialCardView>(R.id.cv_dividing_user_answer)
